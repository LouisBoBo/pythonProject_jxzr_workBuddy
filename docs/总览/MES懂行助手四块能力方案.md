...
> 状态：**方案稿（待评审）** · 2026-08-21 同步 P0-01 话术边界  
> 日期：2026-08-17  
...
> 一句话定位：对**已有 MES**——**读懂资料包 → 查得动（缺口透明）→ 运维帮得上 → 确认后写码改功能**；人不离开同一对话入口。A/B/C/D **均为核心能力**。  
> **对外边界**：卖「懂资料包 + 能查能值班 + 能改码（确认后）+ 缺口说清楚」；**不卖**全能 MES 大脑。问题 backlog 见 [`问题与风险点确认清单.md`](问题与风险点确认清单.md)。
...
- **对外宣称**「已很懂任意 MES / 已具备全链路追溯与全库 BI / 已可集团生产变更」——能力以资料包与现场 API 为准，缺口必须透明 
...
**完成度提醒（P0-12）**：四块是同一入口的能力地图，**不是**「都齐了=产品完成」。演示须带缺口透明；写码是核心能力，但不可单独成场掩盖 WIP/Lot/全库聚合等未齐项。

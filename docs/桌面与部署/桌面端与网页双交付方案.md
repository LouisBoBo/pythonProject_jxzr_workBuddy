...
> 相关：[`本机目录写码与沙箱隔离方案.md`](../写码与审码/本机目录写码与沙箱隔离方案.md)、[`ERP登录对接说明.md`](../MES业务/ERP登录对接说明.md)、[`平台嵌入说明.md`](../MES业务/平台嵌入说明.md)、[`桌面端安装与配置说明.md`](桌面端安装与配置说明.md)
...
| 嵌入 ERP iframe | [`平台嵌入说明.md`](../MES业务/平台嵌入说明.md) | **不替代**；嵌入场景仍用网页 |
...
3. 登录 → 与网页同一套鉴权流程（见 [`ERP登录对接说明.md`](../MES业务/ERP登录对接说明.md)）
...
- 用户文档（落地后另写）：`docs/桌面与部署/桌面端安装与配置说明.md`（安装步骤、配 Key、常见问题）
...
| 网页启动 | `scripts/dev.sh` |
| 桌面壳 | `desktop/`、`scripts/run-desktop-dev.sh`、`scripts/package-desktop.sh`、`docs/桌面与部署/桌面端安装与配置说明.md` |

...
- 能力分层与非目标：[`第二阶段产品方向.md`](./第二阶段产品方向.md)  
- Tools / Skills 扩展方式：[`DeepAgents-Skills使用指南.md`](./DeepAgents-Skills使用指南.md)  
- 身份与嵌入：[`平台嵌入说明.md`](./平台嵌入说明.md)  
- 现有「Cursor 评审提示词」可迁移为 Skill 内标准 `prompt` 模板：[`阶段收口评审与验收清单.md`](./阶段收口评审与验收清单.md)

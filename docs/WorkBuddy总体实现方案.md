...
| 文档 | 用途 |
|------|------|
| `docs/Cursor写码车道原理与完整流程.md` | 写码流程详解 |
| `docs/Cursor写码车道管理员上线清单.md` | 上线配置与检查 |
| `docs/本机目录写码与沙箱隔离方案.md` | 本机目录写码（默认）与沙箱隔离 |
| `docs/桌面端与网页双交付方案.md` | 桌面安装包 + 保留网页；谨慎分阶段落地 |
| `docs/IDE代码审核开发者接入手册.md` | 本机审码接入 |
| `docs/功能清单与测试用例.md` | 功能条目与验收 |
| `docs/每日复盘总结/2026-08-10.md` | 近期质量与意图相关结论 |
| `README.md` | 本地启动说明 |
